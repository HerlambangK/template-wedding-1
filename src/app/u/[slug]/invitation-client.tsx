...
function mapInvitation(inv: Invitation) {
  return {
    ...
    resepsi: {
      ...
      time: inv.resepsi_time || inv.akad_time || "08:00",
      endTime: inv.resepsi_end_time || inv.akad_end_time || "10:30",
      venue: inv.resepsi_venue || inv.akad_venue || "",
      address: inv.resepsi_address || inv.akad_address || "",
      mapsUrl: inv.resepsi_maps_url || inv.akad_maps_url || "#",
